        ...
        <div class="lg:col-span-2">
            ...
            <div class="flex items-center mt-4 cursor-pointer" wire:click="completed">
                @if( $current->completed )
                    <i class="fas fa-toggle-on text-2xl text-orange-600"></i>
                @else
                                    ...
                                    <div>
                                        @if($lesson->completed)
                                            @if($current->id == $lesson->id)
                                                <span class="inline-block w-4 h-4 border-2 border-orange-300 rounded-full mr-2 mt-1"></span>
                                            @else
                                                <span class="inline-block w-4 h-4 bg-orange-300 rounded-full mr-2 mt-1"></span>
                                            @endif
                                        @else
                                            @if($current->id == $lesson->id)
